        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text('Issue Submitted - #5766',style: TextStyle(fontSize: 22,fontWeight: FontWeight.w700),),
                SizedBox(height: mediaQuerySize.height*0.02,),
              Text('Thank you for submitting the Issue',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
                              SizedBox(height: mediaQuerySize.height*0.02,),
