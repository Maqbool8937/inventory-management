...
class _TowScreenState extends State<TowScreen> {
  ...
  Future<void> submitTowJob() async {
    ...
    try {
      await _db.collection('tow_jobs').add({
        'order_number': orderNumberController.text.trim(),
        'car_description': carDescriptionController.text.trim(),
        'amount': amountController.text.trim(),
        'timestamp': FieldValue.serverTimestamp(),
      });

      Get.snackbar('Success', 'Tow job saved');
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Image.asset('assets/images/tow-truck_icon.png'),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: mediaQuerySize.height * 0.015.h),
                    CustomButton(
                      onTap: isLoading ? null : submitTowJob,
