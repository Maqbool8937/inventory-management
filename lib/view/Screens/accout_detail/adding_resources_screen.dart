          ...
          child: Padding(
            ...
            child: Column(
             ...
             Container(
              ...
              child: Row(
                children: [
                 _commonContainer(context,topChild: Text(
          '#',
          style: TextStyle(
            ...
            color: Colors.white, // Adjust color
                  ...
                  _commonContainer(context,topChild: Icon(Icons.home_work_outlined,color: AppColors.secondoryColor,),bottomChild: Text('MS32',style: AppTextstyles.simpleText())),
                   _commonContainer(context,topChild:Icon(Icons.home,color: AppColors.secondoryColor,),bottomChild: Text('MS32',style: AppTextstyles.simpleText()))
             ...
             SizedBox(height: mediaQuerySize.height*0.03.h,),
             Center(
              child: Text('Sales History',style: AppTextstyles.BoldBlackText(),),
             ),
             SizedBox(height: mediaQuerySize.height*0.03.h,),
             Container(
