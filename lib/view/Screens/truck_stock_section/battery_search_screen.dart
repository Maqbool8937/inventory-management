...
class BatterySearchScreen extends StatelessWidget {
  const BatterySearchScreen({super.key});
        ...
        child: SafeArea(
          child: Padding(
            ...
            padding: EdgeInsets.symmetric(vertical: mediaQuerySize.height * 0.01.h, horizontal: mediaQuerySize.width * 0.03.w),
                      child: CustomField(isPrefixIcon: true,prefixIcon: Padding(
                                  padding: EdgeInsets.symmetric(vertical: mediaQuerySize.height * 0.01.h, horizontal: mediaQuerySize.width * 0.03.w),
                        child: Text('244-C',style: AppTextstyles.NormalBlackText(),),
                      ),isSuffixIcon: true,suffixIcon: Padding(
                                  padding: EdgeInsets.symmetric(vertical: mediaQuerySize.height * 0.01.h, horizontal: mediaQuerySize.width * 0.03.w),
              ...
              CustomButton(name: 'Search'),
               ...
               Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Battery 244-C',style: AppTextstyles.BoldBlackText(),),
                     SizedBox(height: mediaQuerySize.height*0.03.h,),
                    CustomButton(
               ...
               Column(
                children: [
                  Row(
                    ...
                    SizedBox(width: mediaQuerySize.width*0.01.w,),
